...
('Sale-Marketing'), ('Hành chính'), ('Phục vụ'), ('Quản lí');
insert into nhan_vien (ho_ten, ngay_sinh, so_cmnd, luong, so_dien_thoai, email, dia_chi, ma_vi_tri, ma_trinh_do, ma_bo_phan)
values('Nguyễn Văn An', '1970-11-07', '456231786', 10000000, '0901234101', 'annguyen@gmail.com', '295 Nguyễn tất Thành, Đà Nẵng', 1, 3, 1),
('Lê Văn Bình','1997-04-09', '654231234', 7000000, '0934212314', 'binhlv@gmail.com', '22 Yên bái, Đà Nẵng', 1, 2, 2),
('Hồ Thị Yến', '1995-12-12', '999231723', 14000000, '0412352315', 'thiyen@gmail.com', 'K234/11 Điện Biên Phủ, Gia Lai', 1, 3, 2),
('Võ Công Toản', '1980-04-04', '123231365', 1700000, '0374443232', 'toan0404@gmail.com', '77 Hoàng Diệu, Quảng Trị', 1, 4, 4),
('Nguyễn Bỉnh Phát', '1999-12-09', '454363232', 6000000, '0902341231', 'phatphat@gmail.com', '43 Yên Bái, Đà Nẵng', 2, 1, 1),
('Khúc Nguyễn An Nghi', '2000-11-08', '964542311', 7000000, '0978653213', 'annghi20@gmail.com', '294 Nguyễn Tất Thành, Đà Nẵng', 2, 2, 3),
('Nguyễn Hữu Hà', '1993-01-01', '534323231', 80000000, '0941234553', 'nhh0101@gmail.com', '4 Nguyễn Chí Thanh, Huế', 2, 3, 2),
('Nguyễn Hà Đông', '1989-09-03', '234414123', 9000000, '0642123111', 'donghanguyen@gmail.com', '111 Hùng Vương, Hà Nội', 2, 4, 4),
('Tòng Hoang', '1982-09-03', '256781231', 60000000, '0245144444', 'hoangtong@gmail.com', '213 Hàm Nghi, Đà Nẵng', 2, 4, 4),
...
values('Villa Beach Front', 25000, 1000000000, 10, 'vip', 'có hồ bơi', 500, 4, 3, 1),
('House Princess 01', 14000, 50000000, 7, 'vip', 'có thêm bếp nướng', null, 3, 2, 2),
('Room Twin 01', 5000, 1000000000, 2, 'normal', 'có ti vi', null, null, 4, 3),
...
select kh.ho_ten, count(hop_dong.ma_khach_hang) from khach_hang kh 
...
group by month(ngay_lam_hop_dong) ;
 ...
 select hop_dong.ma_hop_dong , hop_dong.ngay_lam_hop_dong, hop_dong.ngay_ket_thuc, hop_dong.tien_dat_coc, count(hop_dong_chi_tiet.ma_dich_vu_di_kem) as so_luong_dich_vu_di_kem
...
select hd.ma_hop_dong as id, nv.ho_ten, kh.ho_ten, kh.so_dien_thoai, dv.ma_dich_vu, dv.ten_dich_vu, ifnull(sum(hdct.so_luong),0) as quantity, hd.tien_dat_coc
from hop_dong hd join khach_hang kh using (ma_khach_hang)
join nhan_vien nv using (ma_nhan_vien)
join dich_vu dv using(ma_dich_vu)
left join hop_dong_chi_tiet hdct on hd.ma_hop_dong = hdct.ma_hop_dong_chi_tiet
